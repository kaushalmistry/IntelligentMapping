...
Here the static information is the traffic in the bank
IF at any point the traffic is above the threshold value then will update 
the mapping for balanced load.
*/
...
ofstream DATA_COLLECTION("QueueSizes.csv");
